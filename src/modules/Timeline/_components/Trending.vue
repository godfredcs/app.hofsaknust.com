...
<div>
    ...
    <div class="widget-content">
        ...
        <li class="from_user left"> <a href="#" class="avatar"><img src="/static/img/message_avatar1.png"/></a>
        ...
        <li class="by_myself right"> <a href="#" class="avatar"><img src="/static/img/message_avatar2.png"/></a>
            <div class="message_wrap"> <span class="arrow"></span>
        ...
        <li class="from_user left"> <a href="#" class="avatar"><img src="/static/img/message_avatar2.png"/></a>
            <div class="message_wrap"> <span class="arrow"></span>
