        ...
        <div class="span5">
          <div class="widget">
            ...
            <div class="widget-content">
                <div class="shortcuts">
                    <router-link exact to="/timeline" tag="a" active-class="shortcut-active" class="shortcut">
                        <i class="shortcut-icon icon-list-alt"></i>
                        <span class="shortcut-label">Trending</span>
                    </router-link>
                    ...
                    <router-link to="/timeline/users" tag="a" active-class="shortcut-active" class="shortcut">
